-- ============================================================================
-- ETERNA Time Capsule - Database Schema (Local Development)
-- ============================================================================
-- This file creates ONLY the essential tables needed for ETERNA to work
-- Compatible with all PHP backend files
-- For use with XAMPP/localhost environment
-- ============================================================================

DROP DATABASE IF EXISTS eternaDb_;
CREATE DATABASE eternaDb_;
USE eternaDb_;
...
-- Ready to use with ETERNA application
